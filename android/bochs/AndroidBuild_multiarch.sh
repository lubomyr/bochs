...
env LIBS="-lgnustl_static" \
	../setEnvironment-$1.sh sh -c "cd bochs-$1 && ./configure --build=x86_64-unknown-linux-gnu --host=$2 --with-sdl --enable-clgd54xx --enable-voodoo --enable-sb16 --disable-gameport --enable-ne2000 --enable-usb"
fi
